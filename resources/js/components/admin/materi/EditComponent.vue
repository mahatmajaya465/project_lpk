      ...
      <div class="container-xl">
        <div class="row g-2 align-items-center">
          <div class="col">
            ...
            <h2 class="page-title">Edit Materi</h2>
          </div>
        </div>
      </div>
    </div>
  ...
  methods: {
    ...
    submitMateriData() {
      ...
      try {
        ...
        axios
          .post(`/v1/materi/update/${this.$route.params.id}`, formData)
          .then((response) => {
    ...
    fetchMateriData() {
      try {
        axios.get(`/v1/materi/find/${this.$route.params.id}`).then((response) => {
          this.materi = response.data.data;
          this.$nextTick(() => {
            this.initTinyMCE();
            tinyMCE.on("AddEditor", () => {
              tinyMCE.get("tinymce-mytextarea").setContent(this.materi.deskripsi || "");
            });
          });
        });
      } catch (error) {
